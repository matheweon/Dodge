...
public class Info implements Screen {
    ...
    private static final int HOME_BUTTON_X_VALUE = 0;
    private static final int HOME_BUTTON_Y_VALUE = DodgeGame.HEIGHT - HOME_BUTTON_SIZE;
    ...
    public void render(float delta) {
        ...
        game.batch.draw(homeButton, HOME_BUTTON_X_VALUE, HOME_BUTTON_Y_VALUE, HOME_BUTTON_SIZE, HOME_BUTTON_SIZE);
        if (Gdx.input.getX() > HOME_BUTTON_X_VALUE &&
                Gdx.input.getX() < HOME_BUTTON_X_VALUE + HOME_BUTTON_SIZE &&
                DodgeGame.HEIGHT - Gdx.input.getY() > HOME_BUTTON_Y_VALUE &&
                DodgeGame.HEIGHT - Gdx.input.getY() < HOME_BUTTON_Y_VALUE + HOME_BUTTON_SIZE &&
